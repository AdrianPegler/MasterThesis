...
set xrange [ 1024.00 : * ] noreverse nowriteback
...
plot 'results/grav_1_X_raw.dat' using 1:2 with points title "Laufzeitdaten", g(x) title "lineare Approximation"
## fit g(x) 'results/grav_1_X_raw.dat' using 1:2 via m, b
#    EOF
