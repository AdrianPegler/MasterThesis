...
$G$ durch Matrizen $A$ und $B$ durch $G = A\trans{B}$.
    ...
    \label{sec:approx}
      ...
      Der Aufbau folgt weitestgehend dem von \citet{nichtlokop}. Für eine Approximation einer nicht-entarten Kernfunktion durch Taylor-Entwicklung sei wiederum auf \citet{h2diss} verwiesen. 
