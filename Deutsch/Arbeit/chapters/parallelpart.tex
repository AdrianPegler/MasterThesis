...
void _setup(Cluster *c, int depth){
  ...
  \label{sec:data}
    ...
    Prozessen und die Zahl $m := 2^\tcode{pot}$ für die durchschnittliche Anzahl \code{bodies} pro Prozess.
...
% 	       Nicht schraffiert: Blöcke für die alle Daten vorliegen.\\
    ...
    Diesmal müssen also für die Kommunikation manuell Sende- und Empfangspuffer angelegt werden. Der zugehörige Code ist in der Datei \code{eval.c} zu finden und wird im Folgenden erläutert.
